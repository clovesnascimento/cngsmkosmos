...
2. Se a tarefa pedir para criar arquivos, landing pages ou scripts, VOCÊ DEVE usar as funções do Python (ex: `open().write()`, `os.makedirs()`) para criar os arquivos reais no diretório atual (workspace).
3. Use print() para mostrar o progresso e o resultado final.
4. Trate erros com try/except quando necessário.
5. Seja conciso e eficiente.
6. Você está operando em um workspace isolado. Todos os arquivos criados aparecerão lá automaticamente.

Responda em formato JSON:
{
    "thought": "seu raciocínio sobre como resolver",
    "code": "código python completo e executável que realiza a ação real",
